...
namespace BlackTundra.World.Damagers {
    ...
    public abstract class BaseDamager : MonoBehaviour {
        ...
        /// <summary>
        /// Minimum amount of raw blunt impact damage that can be delt by this <see cref="BaseDamager"/>.
        /// </summary>
#if UNITY_EDITOR
...
#endif
        [SerializeField]
        protected float minDamage = 0.05f;

        /// <summary>
        /// Maximum amount of raw blunt impact damage that can be delt by this <see cref="BaseDamager"/>.
        /// </summary>
#if UNITY_EDITOR
...
#endif
        [SerializeField]
        protected float maxDamage = 1.0f;
...
#endif
        [SerializeField]
        protected float minImpactForce = 1.0f;
...
#endif
        [SerializeField]
        protected float maxImpactForce = 10.0f;
        ...
        protected abstract void OnImpact(in IDamageable damageable, in Object sender, in float impactDamage, in Vector3 point, in Vector3 velocity);
